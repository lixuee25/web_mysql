...
?>
    <form action="pages/main/xulythanhtoan.php" method="POST">
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <table style="width:100%; text-align: center; border-collapse: collapse;"border="1">
            ...
            <tr>
                ...
                <td>
                    <a href="pages/main/themgiohang.php?cong=<?php echo $cart_item['id'] ?>"><i class="fas fa-plus-circle" aria-hidden="true"></i></a>
                    <?php echo $cart_item['soluong']; ?>
                    <a href="pages/main/themgiohang.php?tru=<?php echo $cart_item['id'] ?>"><i class="fas fa-minus-circle" aria-hidden="true"></i></a>
                </td>
        ...
        <div class="col-md-4 hinhthucthanhtoan">
          <h4>Phương thức thanh toán</h4>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" name="payment" id="flexCheckDisabled1" value="tienmat" checked>
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" name="payment" id="flexCheckDisabled2" value="chuyenkhoan" >
            ...
            <!-- <div class="form-check">
              <input class="form-check-input" type="checkbox" name="payment" id="flexCheckDisabled3" value="momo" >
              <img src="images/momo.png" height="40" weight="32">
            ...
            <!-- <div class="form-check">
              <input class="form-check-input" type="checkbox" name="payment" id="flexCheckDisabled4" value="vnpay">
              <img src="images/vnpay.png" height="32" weight="32">
            ...
            <!-- <div class="form-check">
              <input class="form-check-input" type="checkbox" name="payment" id="flexCheckDisabled3" value="paypal" >
              <img src="images/paypal.png" height="30" weight="20">
              <label class="form-check-label" for="flexCheckDisabled3">
                Paypal
              </label>
            </div> -->
        ...
        <div id="paypa-button"></div> -->
        

            <!-- <div class="form-check">
              <input class="form-check-input" type="checkbox" name="payment" id="flexCheckDisabled5" value="visa">
              <img src="images/visa.png" height="20" weight="32">
              <label class="form-check-label" for="flexCheckDisabled5"></label>
                Visa
              </label>
            </div> -->
