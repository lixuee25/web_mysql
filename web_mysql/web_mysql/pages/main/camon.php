<?php
    ...
    if(isset($_GET['vnp_Amount'])) {
        ...
        //     VALUE('".$vnp_Amount."','".$code_cart."','".$vnp_BankCode."','".$vnp_BankTranNo."','".$vnp_CardType."','".$vnp_OrderInfo."','".$vnp_PayDate."'
        //     ,'".$vnp_TmnCode."','".$vnp_TransactionNo."')";
        // $cart_query = mysqli_query($mysqli,$insert_vnpay);
        // if($cart_query) {
        //     //insert gio hang
        //     echo '<h3>Giao dịch thanh toán bằng VNPAY thành công</h3>';
        //     echo '<p>Vui lòng vào trang <a target="_blank" href="index.php?quanly=lichsudonhang">Lịch sử đơn hàng</a> để xem thêm chi tiết đơn hàng của bạn</p>';
